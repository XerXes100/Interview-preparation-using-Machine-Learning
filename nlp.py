...
def get_audio_pace(audio_file_path, s):
    ...
    # print(pace)
    if pace > 190:
        pace_result = "While your response contains valuable content, the pace of your delivery seems to be too fast. It's " \
        ...
        pace_result = "While your response contains valuable information, the pace of your delivery seems to be too slow. It " \
        ...
        pace_result = "Your response is delivered at a good speed, allowing the information to flow naturally and keeping the listener engaged. It's evident that you have taken the time to organize your thoughts and convey the listener engaged. It's evident that you have taken the time to organize your thoughts and convey your ideas clearly and efficiently. Keep up the good work in maintaining a balanced and effective pace in your future responses!"
